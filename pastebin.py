...
DEV_KEY: str = "token"  # your dev key, shown at https://pastebin.com/api#1
...
def clipboard_to_link(name="https://github.com/riggedCoinflip/pastebin.py", language="python", private="0", expire="N"):
